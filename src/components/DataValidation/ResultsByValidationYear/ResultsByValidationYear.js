...
import "./ResultsByValidationYear.css";

function ResultsByValidationYear() {
    ...
    return (
        <div className="data-validation-container">
            <DataValidationHeader title={"DATA VALIDATION REPORTS"} subTitle={"Results by Validation Year"} />
            <table className="data-validation-table">
                <th className="table-head" colSpan={2}>Data Validation Report by Validation Year</th>
                <tr>
...
export default ResultsByValidationYear;